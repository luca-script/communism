...
describe('Runtime', function (): void {
    covers([Runtime::class, Manifest::class, Applies::class, Mixin::class, ...COMMUNISM_INJECTOR_COVERAGE_CLASSES]);
    ...
    describe('Manifest', function (): void {
        covers([Manifest::class, ...COMMUNISM_INJECTOR_COVERAGE_CLASSES]);
